...
class Personil extends MY_Controller {
	...
	public function index() {
		...
		$this->renderer
			...
			->data([
				...
				'total_personil' => $this->pegawai_model->count_personil(),
			])
			->nav_index('personil')
			->render();
	}
	...
	public function edit( $content = '' , $id_pegawai = NULL ) {
		...
		if($this->input->method() == 'post') {
			return $this->{'edit_'.$content.'_post'}($id_pegawai);
		}
	...
	private function edit_data_pokok_post($id_pegawai) {
	...
	private function edit_pendidikan_umum() {
		$this->renderer
		->data([
	...
	private function edit_pendidikan_umum_post($id_pegawai) {
		$form_data = $this->input_sanitizer->method('post')
		->array('riwayat_pendidikan_umum')
		->value();
		$this->save_input($form_data);
		...
		$query_result = $this->pegawai_model->update_pendidikan_umum($id_pegawai, $form_data);
		if($query_result !== FALSE) {
			// $this->set_alert(
			// 	'success',
			// 	'Berhasil ditambahkan'
	...
	private function edit_pendidikan_militer() {
		$this->renderer
		->data([
		])
		->render();
	...
	private function edit_pendidikan_militer_post($id_pegawai) {
		$form_data = $this->input_sanitizer->method('post')
		->array('riwayat_pendidikan_militer')
		->value();
		$this->save_input($form_data);
		// echo "<pre>";
		// var_dump($form_data);exit();
		$query_result = $this->pegawai_model->update_pendidikan_militer($id_pegawai, $form_data);
		if($query_result !== FALSE) {
			$this->set_alert(
				'success',
				'Berhasil ditambahkan'
	...
	private function edit_riwayat_pangkat() {
		$pangkat_list            = $this->m_pangkat->get_all();
		$this->renderer
		->inject_json('dataPangkat', $pangkat_list)
		->data([
	...
	private function edit_riwayat_pangkat_post($id_pegawai) {
		$form_data = $this->input_sanitizer->method('post')
		->array('riwayat_pangkat')
		->value();
		$this->save_input($form_data);
		// echo "<pre>";
		// var_dump($form_data);exit();
		$query_result = $this->pegawai_model->update_riwayat_pangkat($id_pegawai, $form_data);
		if($query_result !== FALSE) {
			$this->set_alert(
				'success',
				'Berhasil diedit'
	...
	private function edit_riwayat_jabatan() {
		$status_jabatan_list     = $this->m_status_jabatan->get_all();
		$jabatan_list            = $this->m_jabatan->get_all();
	...
	private function edit_riwayat_jabatan_post($id_pegawai) {
		$form_data = $this->input_sanitizer->method('post')
		->array('riwayat_jabatan')
		->value();
		$this->save_input($form_data);
	...
	private function edit_riwayat_penugasan() {
	...
	private function edit_riwayat_penugasan_post($id_pegawai) {
		$form_data = $this->input_sanitizer->method('post')
		->array('riwayat_penugasan')
		->value();
		$this->save_input($form_data);
	
		$query_result = $this->pegawai_model->update_riwayat_penugasan($id_pegawai, $form_data);
		if($query_result !== FALSE) {
			$this->set_alert(
				'success',
				'Berhasil diedit'
	...
	private function edit_tanda_jasa() {
	...
	private function edit_tanda_jasa_post($id_pegawai) {
		$form_data = $this->input_sanitizer->method('post')
		->array('riwayat_tanda_jasa')
		->value();
		$this->save_input($form_data);

		$query_result = $this->pegawai_model->update_riwayat_tanda_jasa($id_pegawai, $form_data);
		if($query_result !== FALSE) {
			$this->set_alert(
				'success',
				'Berhasil diedit'
	...
	private function edit_data_keluarga() {
	...
	private function edit_data_keluarga_post($id_pegawai) {
		$form_data = $this->input_sanitizer->method('post')
		->array('data_keluarga')
		->value();
		$this->save_input($form_data);
		
		$query_result = $this->pegawai_model->update_data_keluarga($id_pegawai, $form_data);
		if($query_result !== FALSE) {
			$this->set_alert(
				'success',
				'Berhasil ditambahkan'
			);
			redirect('personil/edit/data-keluarga/'.$id_pegawai);
		}
		else {
			$this->set_alert(
				'danger',
